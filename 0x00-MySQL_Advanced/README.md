...
<strong>Context</strong>: Make an attribute unique directly in the table schema will enforced your business rules and avoid bugs in your application
...
- Your script can be executed on any database
<strong>Context</strong>: Calculate/compute something is always power intensive… better to distribute the load!
```
