...
<strong>Install MongoDB 4.2 in Ubuntu 18.04</strong>
...
guillaume@ubuntu:~/0x01$ 
```
<h3>8. List all documents in Python</h3>
...
guillaume@ubuntu:~/0x01$ 
```
<h3>9. Insert a document in Python</h3>
...
guillaume@ubuntu:~/0x01$ 
```
<h3>11. Where can I learn Python?</h3>
...
guillaume@ubuntu:~/0x01$ guillaume@ubuntu:~/0
```
<h3>15. Log stats - new version</h3>
